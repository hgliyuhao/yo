 ...
 */
public class ORecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ORecyclerViewAdapter(Context context,List<List_others> data){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType==First_VIEW){
            ...
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_my, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof SendViewHolder) {
            ...
            viewHolder.textView_info.setTextSize(20);
